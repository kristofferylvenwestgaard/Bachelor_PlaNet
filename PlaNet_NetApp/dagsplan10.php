...
<div class = "container">
		...
		<div class="col-8-12">
	           <div class="grid">
	           		...
	           		<div class "col-1-1">
	           			<div class="handBilde">
	           			<img src="handlingskjedebilder/valghentested.png" width="650px" height="350px" alt="admin"/></a>
	           			</div>
	           		</div>
	     ...
	     <div class="col-2-12">
	     	<div class="dagsChecklist">
					...
					<!--STEG 9-10-->
	     			<a href="dagsplan11.php" class="submit btn btn-xl btn-outline sharp" type="button">10</button></a>
