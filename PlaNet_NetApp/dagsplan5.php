...
<div class = "container">
	...
	<div class="col-1-1">
		...
		<div class="admincontent">
			<div class= "col-3-4">
	           			<div class="aktBilde">
	           			<img src="handlingskjedebilder/nye_bilder_hs/5.png" width="650px" height="370px" alt="5"/></a>
					...
					<div class= "col-1-4">
	           		...
	           		<div class="col-1-1">
	           			<div id="handKnapperPos">
								<div class="col-1-3">
									   <a class="btn btn-warning btn-dobbelxl btn-block sharp" href="dagsplan4.php">
									       <i class="fa fa-arrow-left"></i> Tilbake</a>
								</div>
			
								<div class="col-2-3">
					 					 <a class="btn btn-primary btn-dobbelxl btn-block sharp" href="dagsplan6.php">
