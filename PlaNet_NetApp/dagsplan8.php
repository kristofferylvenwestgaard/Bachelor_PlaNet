...
<div class = "container">
    ...
    <div class="col-8-12">
           <div class="aktivitetNavn">Bestil burger</div>
    </div>
    <div class="col-2-12">
...
<div class = "container">
		...
		<div class="col-8-12">
	           <div class="grid">
	           		...
	           		<div class "col-1-1">
	           			<div class="handBilde">
	           			<img src="handlingskjedebilder/LeggTilHandlekurv.png" width="450px" height="170px" alt="admin"/></a>
	           			</div>
	           		</div>
	     ...
	     <div class="col-2-12">
	     	<div class="dagsChecklist">
					...
					<!--STEG 7-8-->
	     			<a href="dagsplan9.php" class="submit btn btn-xl btn-outline sharp" type="button">8</button></a>
