...
<div class="container">
	...
	<div class="admincontent">
				...
				<div class="col-1-1 draopp">
					<div class="content">
						<input class="input_text" type="text" placeholder="Middag - spaghetti" name="aktivitetsnavn"/>
				...
				<div class="col-1-1 draopp">
					<div class="content">
						...
						<div id="onsdag_gjenta">
							...
							<input class="input_check" type="checkbox" name="onsdag" checked/>
						</div>
					...
					<div class="col-1-1 draopp">
						<div class="content">
							...
							<input type="checkbox" id="checkbox-1-2" class="bluecheckbox" name="blue" checked/><label for="checkbox-1-2"></label>
				...
				<div class="col-1-1">
					<div class="content">
						<div id="skype_check">
							...
							<input class="input_check" type="checkbox" name="skype" checked/>
						</div>
				...
				<div class="col-1-1">
					...
					<div class="content">
								...
								<a class="btn btn-large btn-outline sharp" href="index.php" onclick="return confirm('Avslutte redigering og lagre?')">
  								<i class="fa fa-floppy-o"></i> Ferdig</a>

					</div>
					</div>
					<div class="col-1-2 nesteKnapp">
						<input class="submit btn btn-large sharp" type="submit" value="Steg &#10152;" name="nesteSide"/>
					</div>
